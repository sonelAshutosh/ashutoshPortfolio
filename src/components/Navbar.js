    ...
    <header className="w-full px-32 py-8 font-medium flex items-center justify-between dark:text-light relative z-10 lg:px-16 md:px-12 sm:px-8">
      ...
      {isOpen ? (
        <motion.div
          ...
          className="min-w-[70vw] flex flex-col fixed justify-between items-center top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10 bg-dark/90 dark:bg-light/75 rounded-lg backdrop-blur-md py-32 "
        >
          ...
          <nav className="flex items-center justify-center flex-wrap mt-2 ">
            ...
            <motion.a
              href="https://github.com/sonelAshutosh"
              target={'_blank'}
              whileHover={{ y: -2 }}
              whileTap={{ scale: 0.9 }}
